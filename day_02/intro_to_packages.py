...
while True:
    ...
    if guess_real < target_real:
        print("Real part is too low")
    elif guess_real > target_real:
        print("Real part is too high")
    else:
        print("Real part is correct")

    if guess_imag < target_imag:
        print("Imaginary part is too low")
    elif guess_imag > target_imag:
        print("Imaginary part is too high")
    else:
        print("Imaginary part is correct")
